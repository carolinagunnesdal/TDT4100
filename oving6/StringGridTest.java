...
import oving6.StringGridIterator;
...
public class StringGridTest extends TestCase {
  ...
  public void testGrid() {
    ...
    _test__grid_transitions0_effect_state(gridImpl);
  ...
  public void testGridIteratorColumnMajor() {
    ...
    _test__gridIteratorColumnMajor_transitions0_effect_state(gridImpl, gridIterator);
    _transition_exprAction__gridIteratorColumnMajor_transitions1_actions0(gridImpl, gridIterator);
    _test__gridIteratorColumnMajor_transitions1_effect_state(gridImpl, gridIterator);
    _transition_exprAction__gridIteratorColumnMajor_transitions2_actions0(gridImpl, gridIterator);
    _test__gridIteratorColumnMajor_transitions2_effect_state(gridImpl, gridIterator);
    _transition_exprAction__gridIteratorColumnMajor_transitions3_actions0(gridImpl, gridIterator);
    _test__gridIteratorColumnMajor_transitions3_effect_state(gridImpl, gridIterator);
    _transition_exprAction__gridIteratorColumnMajor_transitions4_actions0(gridImpl, gridIterator);
    _test__gridIteratorColumnMajor_transitions4_effect_state(gridImpl, gridIterator);
    _transition_exprAction__gridIteratorColumnMajor_transitions5_actions0(gridImpl, gridIterator);
    _test__gridIteratorColumnMajor_transitions5_effect_state(gridImpl, gridIterator);
    _transition_exprAction__gridIteratorColumnMajor_transitions6_actions0(gridImpl, gridIterator);
    _test__gridIteratorColumnMajor_transitions6_effect_state(gridImpl, gridIterator);
  ...
  private void _test__grid_transitions0_effect_state(final StringGridImpl it) {
    _test__grid_transitions0_effect_state_objectTests0_test(gridImpl);
    
  }
  
  private void _test__grid_transitions0_effect_state_objectTests0_test(final StringGridImpl it) {
  ...
  private void _test__gridIteratorRowMajor_transitions0_effect_state(final StringGridImpl it, final StringGridIterator gridIterator) {
    _test__gridIteratorRowMajor_transitions0_effect_state_objectTests0_test(gridIterator, gridIterator);
    
  }
  
  private void _test__gridIteratorRowMajor_transitions0_effect_state_objectTests0_test(final StringGridIterator it, final StringGridIterator gridIterator) {
  ...
  private void _test__gridIteratorRowMajor_transitions1_effect_state(final StringGridImpl it, final StringGridIterator gridIterator) {
    _test__gridIteratorRowMajor_transitions1_effect_state_objectTests0_test(gridIterator, gridIterator);
    
  }
  
  private void _test__gridIteratorRowMajor_transitions1_effect_state_objectTests0_test(final StringGridIterator it, final StringGridIterator gridIterator) {
  ...
  private void _test__gridIteratorRowMajor_transitions2_effect_state(final StringGridImpl it, final StringGridIterator gridIterator) {
    _test__gridIteratorRowMajor_transitions2_effect_state_objectTests0_test(gridIterator, gridIterator);
    
  }
  
  private void _test__gridIteratorRowMajor_transitions2_effect_state_objectTests0_test(final StringGridIterator it, final StringGridIterator gridIterator) {
  ...
  private void _test__gridIteratorRowMajor_transitions3_effect_state(final StringGridImpl it, final StringGridIterator gridIterator) {
    _test__gridIteratorRowMajor_transitions3_effect_state_objectTests0_test(gridIterator, gridIterator);
    
  }
  
  private void _test__gridIteratorRowMajor_transitions3_effect_state_objectTests0_test(final StringGridIterator it, final StringGridIterator gridIterator) {
  ...
  private void _test__gridIteratorRowMajor_transitions4_effect_state(final StringGridImpl it, final StringGridIterator gridIterator) {
    _test__gridIteratorRowMajor_transitions4_effect_state_objectTests0_test(gridIterator, gridIterator);
    
  }
  
  private void _test__gridIteratorRowMajor_transitions4_effect_state_objectTests0_test(final StringGridIterator it, final StringGridIterator gridIterator) {
  ...
  private void _test__gridIteratorRowMajor_transitions5_effect_state(final StringGridImpl it, final StringGridIterator gridIterator) {
    _test__gridIteratorRowMajor_transitions5_effect_state_objectTests0_test(gridIterator, gridIterator);
    
  }
  
  private void _test__gridIteratorRowMajor_transitions5_effect_state_objectTests0_test(final StringGridIterator it, final StringGridIterator gridIterator) {
  ...
  private void _test__gridIteratorRowMajor_transitions6_effect_state(final StringGridImpl it, final StringGridIterator gridIterator) {
    _test__gridIteratorRowMajor_transitions6_effect_state_objectTests0_test(gridIterator, gridIterator);
    
  }
  
  private void _test__gridIteratorRowMajor_transitions6_effect_state_objectTests0_test(final StringGridIterator it, final StringGridIterator gridIterator) {
  ...
  private void _test__gridIteratorColumnMajor_transitions0_effect_state(final StringGridImpl it, final StringGridIterator gridIterator) {
    _test__gridIteratorColumnMajor_transitions0_effect_state_objectTests0_test(gridIterator, gridIterator);
    
  }
  
  private void _test__gridIteratorColumnMajor_transitions0_effect_state_objectTests0_test(final StringGridIterator it, final StringGridIterator gridIterator) {
  ...
  private void _test__gridIteratorColumnMajor_transitions1_effect_state(final StringGridImpl it, final StringGridIterator gridIterator) {
    _test__gridIteratorColumnMajor_transitions1_effect_state_objectTests0_test(gridIterator, gridIterator);
    
  }
  
  private void _test__gridIteratorColumnMajor_transitions1_effect_state_objectTests0_test(final StringGridIterator it, final StringGridIterator gridIterator) {
  ...
  private void _test__gridIteratorColumnMajor_transitions2_effect_state(final StringGridImpl it, final StringGridIterator gridIterator) {
    _test__gridIteratorColumnMajor_transitions2_effect_state_objectTests0_test(gridIterator, gridIterator);
    
  }
  
  private void _test__gridIteratorColumnMajor_transitions2_effect_state_objectTests0_test(final StringGridIterator it, final StringGridIterator gridIterator) {
  ...
  private void _test__gridIteratorColumnMajor_transitions3_effect_state(final StringGridImpl it, final StringGridIterator gridIterator) {
    _test__gridIteratorColumnMajor_transitions3_effect_state_objectTests0_test(gridIterator, gridIterator);
    
  }
  
  private void _test__gridIteratorColumnMajor_transitions3_effect_state_objectTests0_test(final StringGridIterator it, final StringGridIterator gridIterator) {
  ...
  private void _test__gridIteratorColumnMajor_transitions4_effect_state(final StringGridImpl it, final StringGridIterator gridIterator) {
    _test__gridIteratorColumnMajor_transitions4_effect_state_objectTests0_test(gridIterator, gridIterator);
    
  }
  
  private void _test__gridIteratorColumnMajor_transitions4_effect_state_objectTests0_test(final StringGridIterator it, final StringGridIterator gridIterator) {
  ...
  private void _test__gridIteratorColumnMajor_transitions5_effect_state(final StringGridImpl it, final StringGridIterator gridIterator) {
    _test__gridIteratorColumnMajor_transitions5_effect_state_objectTests0_test(gridIterator, gridIterator);
    
  }
  
  private void _test__gridIteratorColumnMajor_transitions5_effect_state_objectTests0_test(final StringGridIterator it, final StringGridIterator gridIterator) {
  ...
  private void _test__gridIteratorColumnMajor_transitions6_effect_state(final StringGridImpl it, final StringGridIterator gridIterator) {
    _test__gridIteratorColumnMajor_transitions6_effect_state_objectTests0_test(gridIterator, gridIterator);
    
  }
  
  private void _test__gridIteratorColumnMajor_transitions6_effect_state_objectTests0_test(final StringGridIterator it, final StringGridIterator gridIterator) {
  ...
  public static void main(final String[] args) {
    no.hal.jex.standalone.JexStandalone.main(StringGridTest.class);
  }
}